...
struct RendererDriverGL : public IRendererDriver {
	...
	virtual void CreateVertexBuffer( const VertexBufferHandle handle, const SharedRef<memory_t> mem, const VertexLayoutHandle layoutHandle ) final;
	virtual void DestroyVertexBuffer( const VertexBufferHandle handle ) final;
	virtual void CreateIndexBuffer( const IndexBufferHandle handle, const SharedRef<memory_t> mem ) final;
	...
	virtual void CreateProgram( const ShaderProgramHandle handle, const SharedRef<memory_t> vertexShaderMem, const SharedRef<memory_t> fragmentShaderMem ) final;
...
void VertexBufferGL::Create( const SharedRef<memory_t> mem, const VertexLayoutHandle layoutHandle ) {
	size = mem->size;
...
void IndexBufferGL::Create( const SharedRef<memory_t> mem ) {
	size = mem->size;
...
void ShaderGL::Create( const SharedRef<memory_t> mem, GLenum shaderType ) {
	type = shaderType;
...
void RendererDriverGL::CreateVertexBuffer( const VertexBufferHandle handle, const SharedRef<memory_t> mem, const VertexLayoutHandle layoutHandle ) {
...
void RendererDriverGL::CreateIndexBuffer( const IndexBufferHandle handle, const SharedRef<memory_t> mem ) {
...
void RendererDriverGL::CreateProgram( const ShaderProgramHandle handle, const SharedRef<memory_t> vertexShaderMem, const SharedRef<memory_t> fragmentShaderMem ) {
