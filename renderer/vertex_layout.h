...
enum class vertexInputElement_t : uint8_t {
	Position,			// a_position
	Normal,				// a_normal
	Tangent,			// a_tangent
	Color0,				// a_color0
...
enum class vertexInputFormat_t : uint8_t {
	Float2,
	Float3,
	Float4,
	UByte3,
...
struct vertexInputElementDesc_t {
	vertexInputElement_t inputElement;
	vertexInputFormat_t inputFormat;
	uint16_t alignedOffset;
};

struct vertexInputLayoutDesc_t {
	vertexInputElementDesc_t *inputElementDescs;
